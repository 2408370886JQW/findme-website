...
const translations: Translations = {
  ...
  ug: {
    // Navigation
    "nav.features": "يادرولۇق ئىقتىدارلار",
    ...
    "hero.stat.2.value": "85%",
    "hero.stat.2.label": "تورسىز ئاكتىپلىق",
    "hero.stat.3.value": "3.5x",
    ...
    "hero.card.2.desc": "8 ئېتىبار",
    
    // Core Value Section
    "value.title.1": "ئۈچ ئۆلچەملىك بىرلەشتۈرۈش",
    ...
    "value.1.desc": "100% ھەقىقىي كىملىك دەلىللەش\n85% تورسىز ئاكتىپلىق كاپالىتى\nيالغان ئىجتىمائىي ئالاقىدىن خوشلىشىش",
    ...
    // Features Section
    "features.title": "يادرولۇق ئىقتىدارلار",
    ...
    "advantages.1.desc": "100% ھەقىقىي كىملىك دەلىللەش، 85% تورسىز ئاكتىپلىق كاپالىتى، يالغان ئىجتىمائىي ئالاقىدىن خوشلىشىش",
    ...
    "footer.product.features": "يادرولۇق ئىقتىدارلار",
